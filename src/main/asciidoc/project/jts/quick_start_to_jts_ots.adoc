...
See https://github.com/jbosstm/narayana/tree/7.2.2.Final/ArjunaCore/scripts/<VARIANT>-setup-env.sh or https://github.com/jbosstm/narayana/tree/7.2.2.Final/ArjunaCore/scripts/<VARIANT>-setup-env.bat for details.
...
The transaction factory can be started with https://github.com/jbosstm/narayana/tree/7.2.2.Final/ArjunaCore/scripts/start-transaction-service.[PLATFORM_ENDING].
...
In order to do this, you should run the https://github.com/jbosstm/narayana/tree/7.2.2.Final/ArjunaCore/scripts/start-recovery-manager.[PLATFORM_ENDING] script.
